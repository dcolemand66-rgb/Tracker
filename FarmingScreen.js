...
// The guide lives in code, not in saved data — only your check-offs and
// notes are stored. Step ids are stable so content can be expanded
// without losing progress you've already made.
//
// Each step has:
//   detail   – why this matters and what you're deciding
//   actions  – concrete things to actually go and do, in order
//   watchOut – the mistake people most often make here
//   doneWhen – how you know you can tick it off
export const FARMING_PHASES = [
  {
    id: 'foundation',
    name: 'Foundations',
    icon: '🌱',
...
export default function FarmingScreen({ farmingProgress, setFarmingProgress }) {
  ...
  return (
    <ScrollView contentContainerStyle={shared.container}>
      <Text style={shared.h1}>Farming</Text>
      <Text style={shared.tagline}>Building a farming business, step by step</Text>
